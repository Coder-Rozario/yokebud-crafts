			...
			<body>
				<div class="container">
					...
					<xsl:if test="sitemap:urlset">
						<xsl:choose>
							<!-- Case 1: URLs have category tags (group by category) -->
							<xsl:when test="sitemap:urlset/sitemap:url/sitemap:category">
							...
							<!-- Case 2: No category tags (show flat list) -->
							<xsl:otherwise>
								<div class="category-group">
									<div class="category-header">
										<span>All URLs</span>
										<span class="category-count"><xsl:value-of select="count(sitemap:urlset/sitemap:url)" /> Items</span>
									</div>
									<table>
										<thead>
											<tr>
